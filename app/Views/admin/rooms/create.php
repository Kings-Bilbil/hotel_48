...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <div class="form-card">
            <h3 class="font-playfair text-dark mb-4 text-center">Tambah Tipe Kamar</h3>
            
            <form action="index.php?action=rooms_store" method="POST">
                
                <label class="form-label-custom">Nama Tipe</label>
                <input type="text" name="type_name" class="form-control-custom" placeholder="Contoh: Deluxe Room" required>

                <label class="form-label-custom">Harga per Malam</label>
                <input type="number" name="price" class="form-control-custom" placeholder="0" required>

                <label class="form-label-custom">Deskripsi</label>
                <textarea name="description" class="form-control-custom" rows="4" placeholder="Fasilitas dan detail kamar..."></textarea>
